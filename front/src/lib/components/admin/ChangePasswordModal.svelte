<script lang="ts">
  ...
  export let openModal: (open: boolean) => void;
  $: isConfirmMessage = false;

  const openConfirmMessage = (open: boolean) => {
    isConfirmMessage = open;
  }
...
{#if isOpenModal}
  <div
    ...
    <div
      class="fixed z-10 inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
      ...
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <div
          ...
          <div class="flex flex-col max-w-md items-center gap-4 mx-auto">
            <div class="w-full">
              <label for="current-password" class="block text-sm font-medium leading-6 text-gray-900">현재 비밀번호</label>
              <div class="mt-2">
            ...
            <div class="w-full">
              <label for="password" class="block text-sm font-medium leading-6 text-gray-900">새 비밀번호</label>
              <div class="mt-2">
            ...
            <div class="w-full">
              <label for="confirm-password" class="block text-sm font-medium leading-6 text-gray-900">비밀번호 확인</label>
              <div class="mt-2">
          ...
          <div class="flex gap-2 mt-5 sm:mt-6">
            ...
            <button
              on:click={() => openConfirmMessage(true)}
              type="button"
              class="inline-flex w-2/3 justify-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">
              변경 완료
            </button>
          </div>
        </div>
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div
            ...
            <div class="text-center text-gray-700">
              비밀번호가 정상적으로 변경되었습니다. <br/>
              이제, 리그 정보를 등록하겠습니다.
            </div>
            <div class="mt-5 sm:mt-6">
              <button
                on:click={() => openConfirmMessage(false)}
                type="button"
