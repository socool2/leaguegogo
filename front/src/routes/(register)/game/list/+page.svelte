<script lang="ts">
  ...
  type Game = {
    ...
    team2_id: string
    game_date: Date
    team1_point: string | null
    team1_result: string | null
    team2_point: string | null
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tr>
                  ...
                  <th scope="col" class="px-3 py-3.5 text-left w-full text-sm font-semibold text-gray-900">진행 현황</th>
                ...
                {#each sampleGame as game, i}
                  <tr class="even:bg-gray-50">
                    ...
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 text-left">{game.game_round}</td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-400 text-center">{game.team1_id} vs {game.team2_id}</td>
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                {#each sampleTeam as team}
                  <tr class="even:bg-gray-50">
                    <td
                      class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">{team.rank}
                    </td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 text-center">{team.name}</td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 text-left">{team.point}</td>
